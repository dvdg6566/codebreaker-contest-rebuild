...
// TODO: The following functions need their own IAM roles to be created
// Similar to testdata-upload-role, but for statements, checkers, graders, and attachments

/**
 * Get temporary credentials for uploading statements
 * @deprecated Not implemented - needs statements-upload-role
 */
export async function getStatementUploadCredentials(
  _problemName: string,
  _username: string
): Promise<TemporaryCredentials & { bucket: string; keyPrefix: string }> {
  throw new Error("Statement upload credentials not implemented - needs IAM role");
}

/**
 * Get temporary credentials for uploading checkers
 * @deprecated Not implemented - needs checkers-upload-role
 */
export async function getCheckerUploadCredentials(
  _problemName: string,
  _username: string
): Promise<TemporaryCredentials & { bucket: string; keyPrefix: string }> {
  throw new Error("Checker upload credentials not implemented - needs IAM role");
}

/**
 * Get temporary credentials for uploading graders
 * @deprecated Not implemented - needs graders-upload-role
 */
export async function getGraderUploadCredentials(
  _problemName: string,
  _username: string
): Promise<TemporaryCredentials & { bucket: string; keyPrefix: string }> {
  throw new Error("Grader upload credentials not implemented - needs IAM role");
}

/**
 * Get temporary credentials for uploading attachments
 * @deprecated Not implemented - needs attachments-upload-role
 */
export async function getAttachmentUploadCredentials(
  _problemName: string,
  _username: string
): Promise<TemporaryCredentials & { bucket: string; keyPrefix: string }> {
  throw new Error("Attachment upload credentials not implemented - needs IAM role");
}
