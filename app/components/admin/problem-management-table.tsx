...
export const sampleProblems: ProblemListItem[] = [
  {
    problemName: "two_sum",
    title: "Two Sum",
    problem_type: "Batch",
  ...
  {
    problemName: "dynamic_programming",
  ...
  {
    problemName: "communication_protocol",
